...
<div class="relative max-w-screen-xl px-4 py-8 mx-auto">
    <div class="grid lg:grid-cols-12 md:grid-cols-6 sm:grid-cols-1">
        <div class="col-span-6">
            <p>
                <span class="text-2xl uppercase font-semibold align-baseline">Judul Film </span>                
                <span class="text-3xl font-semibold align-baseline">|</span>
                13 Agustus 2022
            </p>

            <div class="my-12 mx-auto">
                <img class="bg-black object-contain rounded-3xl h-62 w-36" src="src/assets/images/film/poster-thumbnail.jpg">
            </div>
        </div>
    </div>
</div>
